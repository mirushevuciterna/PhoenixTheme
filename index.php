...
<?php 
    ...
    get_template_part('modules/donation-video');
    get_template_part('modules/donate-component');
    get_template_part('modules/active-events-component');
    get_template_part('modules/volunteers-component');
